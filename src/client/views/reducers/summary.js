...
export const getAllBuscoData = createSelector(
  ...
  (state) => getBuscoData(state,Object.values(getBuscoSets(state))[6] || false),
  (state) => getBuscoData(state,Object.values(getBuscoSets(state))[7] || false),
  (state) => getBuscoData(state,Object.values(getBuscoSets(state))[8] || false),
  (state) => getBuscoData(state,Object.values(getBuscoSets(state))[9] || false),
  (sets, ...other) => {
