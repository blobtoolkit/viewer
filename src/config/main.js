...
const BTK_API_URL = process.env.BTK_API_URL || BTK_HOST+':'+BTK_API_PORT+'/api/v1'
...
module.exports = {
  ...
  // version
  'version': process.env.BTK_VERSION || 'v1.2',
  // hostname
  'hostname': BTK_HOST,
  // API URL
  'apiUrl': process.env.BTK_API_URL || (BTK_HTTPS ? 'https' : 'http') + '://'+BTK_HOST+':'+BTK_API_PORT+'/api/v1',
